...
while (true) {
	...
	let activity = "dancing"; // Those were some nice type annotations you had here!
	let capacity: number = 10; // It'd be a shame if we ... *erased* them! 😈
	let requiresSupplies = false;
